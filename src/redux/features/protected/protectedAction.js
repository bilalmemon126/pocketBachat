...
export const resetPasswordProtectedRoute = createAsyncThunk('resetPasswordProtectedRoute', async (data, {rejectWithValue}) => {
    try{
        const response = await fetch(`${backendUrl}/reset-password/protected`, {
            method: "GET",
            credentials: "include"
        })
